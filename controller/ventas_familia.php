...
class ventas_familia extends fbase_controller
{
    ...
    private function modificar()
    {
        ...
        if ($this->familia->save()) {
            ...
            // Actualizar atributos si cambio herencia
            $atributo = new atributo_familia();
            if($oldmadre != $this->familia->madre) {
                $atributo->actualizar_atributos($this->familia, $oldmadre, $_POST);
            }
